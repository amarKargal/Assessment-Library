...
import static com.pratham.assessment_lib.BaseActivity.colorStateList;
...
@EFragment(resName = "layout_multiple_select_row")
public class MultipleSelectFragment extends Fragment {
    ...
    GifView questionGif;
    @ViewById(resName = "gl_multiselect")
...
//                    buttonView.setTextColor(Assessment_Utility.selectedColor);
                    ...
                    for (int i = 0; i < gridLayout.getRowCount(); i++) {
                        if (((CheckBox) gridLayout.getChildAt(i)).isChecked()) {
                            ((CheckBox) gridLayout.getChildAt(i)).setTextColor(selectedColor);
                        } else {
